export const LENDING_BORROWING_ADDRESS = "0xd5a038Ae2fFe0DC6258DA646Bd96E97b7B256B11";

export const LENDING_BORROWING_ABI = [
    {
        "inputs": [
            {
    ...
    },
    {
        ...
        "name": "_calculateLoanTokenAmountFromETH",
        "outputs": [
            {
                "internalType": "uint256",
                "name": "",
    ...
    {
        "inputs": [],
        "name": "getChainlinkDataFeedForETHUSD",
        "outputs": [
            {
                "internalType": "int256",
                "name": "",
    ...
    },
    {
        ...
        "name": "sendMessageWithCollateralInETH",
        "outputs": [
            {
                "internalType": "bytes32",
                "name": "messageId",
